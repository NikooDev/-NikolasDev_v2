...
const Stats = () => {
	...
	return (
		<div className={Class('fixed bottom-20', Sm ? 'left-0' : Md ? 'left-14' : 'right-14')}>
			<Tippy content={'Likes\n'+ countLike} hideOnClick={false} className="whitespace-pre-line text-center" offset={[0, 17]} placement="left">
				<button className={Class('flex justify-center items-center shadow-lg bg-red-500 h-12 w-12 heart-container', Sm ? 'rounded-tr-3xl rounded-br-3xl' : 'rounded-full')}>
			...
			<Tippy content={'Visites\n'+ countVues} className="whitespace-pre-line text-center" offset={[0, 17.5]} placement="left">
				<button className={Class('flex justify-center items-center shadow-md bg-gradient-to-r from-[#6997f0] to-[#4962dd] h-12 w-12 mt-3', Sm ? 'rounded-tr-3xl rounded-br-3xl' : 'rounded-full')}>
